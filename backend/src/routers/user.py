...
from core import get_current_user, redis_client, s3_client, settings
...
async def get_user_endpoint(
	...
	try:
		print(f"Goign for preseigned stuff now: {settings.S3_BUCKET_NAME}, {user.profile_pic_object_name}")
