  ...
  const validate = (values) => {
    ...
    if (!values.password) e.password = 'Password is required.';
      ...
      if (!(hasLetter && hasNumber)) {
        e.password =
          (e.password ? e.password + ' ' : '') + 'Include letters and numbers.';
      }
    }
    ...
    if (!file) e.profile_pic = 'Profile picture is required.';
      ...
      if (!file.type?.startsWith('image/'))
        e.profile_pic = 'File must be an image.';
      const MAX_MB = 5;
      if (file.size > MAX_MB * 1024 * 1024)
        e.profile_pic = `Image must be under ${MAX_MB}MB.`;
    }
  ...
  const fields = [
    {
      ...
      props: {
        ...
        'aria-describedby':
          touched.name && currentErrors.name ? 'error-name' : undefined,
      },
    ...
    },
    {
      ...
      props: {
        ...
        'aria-describedby':
          touched.email && currentErrors.email ? 'error-email' : undefined,
      },
    ...
    },
    {
      ...
      props: {
        ...
        'aria-describedby':
          touched.profile_pic && currentErrors.profile_pic
            ? 'error-profile_pic'
            : undefined,
      },
